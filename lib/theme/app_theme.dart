...
class AppTheme {
  ...
  static Future<void> initialize() async {
    ...
    _colorScheme = ColorScheme(
      ...
      // Material 3 surface container tokens
      surfaceContainerLowest: Color(int.parse(lightColors['surfaceContainerLowest'].substring(1, 7), radix: 16) + 0xFF000000),
      surfaceContainerLow: Color(int.parse(lightColors['surfaceContainerLow'].substring(1, 7), radix: 16) + 0xFF000000),
      surfaceContainer: Color(int.parse(lightColors['surfaceContainer'].substring(1, 7), radix: 16) + 0xFF000000),
      surfaceContainerHigh: Color(int.parse(lightColors['surfaceContainerHigh'].substring(1, 7), radix: 16) + 0xFF000000),
      surfaceContainerHighest: Color(int.parse(lightColors['surfaceContainerHighest'].substring(1, 7), radix: 16) + 0xFF000000),
    );
